...
export default class SameVectorSpaceDiffBases extends HTMLElement{
    constructor(){
        super();
        this.state = {
            bases: [[1,0],[0,1]],
    ...
    getBasesGrid(){
        ...
        for(let i=0; i<midX; i++){
            ...
            lines.push(...[
                createSVGElement(
                    "line", {x1:0, y1:0, x2:bases[1][0], y2: bases[1][1]*cellSize*midY, stroke:"rgba(0, 0, 0, 0.4)",
                ...
                createSVGElement(
                    "line", {x1:0, y1:0, x2:bases[1][0], y2: bases[1][1]*cellSize*midY, stroke:"rgba(0, 0, 0, 0.5)",
                        transform: `translate(${midX*cellSize + i*cellSize}, ${midY*cellSize}) scale(1, 1)`
                    }
                ),
                createSVGElement(
        ...
        for(let i=0; i<midY; i++){
            ...
            lines.push(...[
                createSVGElement(
                    "line", {x1:0, y1:0, x2:bases[0][0]*cellSize*midX, y2: bases[0][1], stroke:"rgba(0, 0, 0, 0.5)",
...
customElements.define("mf-linear-transform-same-vector-space-same-bases", SameVectorSpaceDiffBases);